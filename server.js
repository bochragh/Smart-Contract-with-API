...
// get one account
app.get('/api/accounts/1', (req, res) => {
  console.log("**** GET /getAccounts ****");
  truffle_connect.start(function (answer) {
...
app.get('/api/get/transaction/number/:id', (req, res) => {
  ...
  truffle_connect.start(function (answer) {
    ...
    res.status(200).send({
     ...
     success: 'true',
     accounts:answer[req.params.id],
     NumTransaction: transactionCount
    });
  })
});
...
app.get('/api/Tx/hash/:id', (req, res) => {
  ...
  truffle_connect.start(function (answer) {
    console.log(answer[req.params.id]);
    var Txhash = web3.eth.getTransaction('0x2b6cff72e1e3ff1eca9fb9d2e676b6e89eca8b1832e91c69d1ffe77baffef984');
...
//sell book 
  app.post('/api/sell/book/:id', (req, res) => {
    ...
    truffle_connect.start(function (answer) {
      console.log(answer[req.params.id]);
      truffle_connect.sellBook(answer[req.params.id], fullname, discription,price, (answer) => {
        res.send(answer);
